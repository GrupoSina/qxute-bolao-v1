...
const HowItWorksDesktop = forwardRef<HTMLDivElement, HowItWorksDesktopProps>(
  ({ id }, ref) => {
    ...
    return (
      ...
      >
        <h1 className="text-[48px] font-chineseRocksRegular text-[#00409F] mt-16">
          COMO FUNCIONA
        </h1>
        <div className="flex w-full justify-center space-x-8">
          <div className="flex flex-col items-center gap-4 w-[220px]">
            <p className="bg-[#1F67CE] text-white py-2 px-8 rounded-full font-chineseRocksRegular text-[20px] mb-[-35px] z-10">
              PASSO 1
            </p>
            <p className="text-[#1F67CE] text-[11px] font-monumentExtendedRegular text-center border-1 border-[#1F67CE] rounded-lg pt-10 pb-4 px-3 w-[230px] h-[118px] justify-center items-center">
        ...
        {isDesktop && (
          <ButtonMovingBorder
            onClick={() => push('/login')}
            borderRadius="50rem"
            className="bg-[#00764B] hover:border-[#00409F]  rounded-full  text-white   border-[2px]"
          >
            Participar
          </ButtonMovingBorder>
        )}
