...
export default function OverallRules() {
  return (
    <div
      className={`bg-white-texture h-full ${openSans.className} flex flex-col items-center justify-center`}
    >
      <div className="max-w-[450px] w-full">
        <h1 className="text-[#00409F] text-[32px] font-normal font-chineseRocksRegular text-center py-6">
          Regras Gerais
        </h1>
        <Accordion
          className="px-8"
        ...
        >
          <AccordionItem
            classNames={{
              base: 'bg-black',
              title: 'text-white text-[18px] font-chineseRocksRegular',
              content: 'text-white',
            }}
            style={{
          ...
          >
            ...
            <div className="pb-4">
              <h1 className="text-[14px]">
                <span className="font-bold">Prazo: </span>Todos os palpites
                devem ser feitos antes do início de cada jogo ou evento.
                Formato: Os palpites devem ser submetidos no formato
                especificado (ex: placar exato, resultado final, etc.).
              </h1>
            </div>
          </AccordionItem>
          <AccordionItem
          ...
          >
            ...
            <div className="pb-4">
              <h1 className="text-[14px]">
                ...
                entrará em contato através do seu WhatsApp pelo número
                cadastrado no seu login para lhe enviar a premiação.{' '}
              </h1>
            </div>
          </AccordionItem>
          <AccordionItem
          ...
          >
            ...
            <div className="pb-4">
              <h1 className="text-[14px]">
                <span className="font-bold">Relatórios: </span>Você pode
                conferir os vencedores de outras rodadas no nosso site.{' '}
              </h1>
            </div>
          </AccordionItem>
          <AccordionItem
          ...
          <AccordionItem
            ...
            classNames={{
              base: 'bg-black',
              title:
                'text-white text-[18px] font-chineseRocksRegular font-normal',
              content: 'text-white',
            }}
            style={{
              backgroundColor: '#1F67CE',
